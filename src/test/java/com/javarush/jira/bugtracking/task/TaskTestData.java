...
public class TaskTestData {
    ...
    public static final TaskToFull taskToFull1 = new TaskToFull(TASK1_ID, "epic-1", "Data", null, "epic", "in_progress", "normal", null, 4, Set.of(), null, new CodeTo(PROJECT1_ID, "PR1"), new CodeTo(SPRINT1_ID, "SP-1.001"), null);
    ...
    public static final TaskToFull taskToFullWithTags = new TaskToFull(TASK1_ID, "epic-1", "Data", null, "epic", "in_progress", "normal", null, 4, Set.of("backend", "api"), null, new CodeTo(PROJECT1_ID, "PR1"), new CodeTo(SPRINT1_ID, "SP-1.001"), null);
    ...
    public static TaskToExt getNewTaskTo() {
        return new TaskToExt(null, "epic-1", "Data New", "task NEW", "epic", "in_progress", "low", null, 3, null, null, PROJECT1_ID, SPRINT1_ID);
    }
    ...
    public static TaskToExt getUpdatedTaskTo() {
        return new TaskToExt(TASK2_ID, "epic-2", "Trees UPD", "task UPD", "epic", "ready_for_review", "high", null, 4, null, null, PROJECT1_ID, SPRINT1_ID);
    }
    ...
    public static TaskToExt getNewTaskToWithTags() {
        return new TaskToExt(null, "epic-1", "Data New", "task NEW", "epic", "in_progress", "low", null, 3, Set.of("backend", "api"), null, PROJECT1_ID, SPRINT1_ID);
    }

    public static TaskToExt getUpdatedTaskToWithTags() {
        return new TaskToExt(TASK2_ID, "epic-2", "Trees UPD", "task UPD", "epic", "ready_for_review", "high", null, 4, Set.of("frontend", "ui"), null, PROJECT1_ID, SPRINT1_ID);
    }
}
